...
const int MODEL_COMMENT_COLUMN = RegisterViewModelBase::Model::COMMENT_COLUMN;

const char *FSR_NAME        = "FSR";
const char *FCR_NAME        = "FCR";
const char *FTR_NAME        = "FTR";
const char *GPRCategoryName = "General Purpose";
...
int distSqr(QPoint const &w1, QPoint const &w2) {
...
QModelIndex findModelCategory(RegisterViewModelBase::Model const *const model, QString const &catToFind) {
...
RegisterGroup *createFPUData(RegisterViewModelBase::Model *model, QWidget *parent) {
	...
	const auto                  group         = new RegisterGroup(QObject::tr("FPU Data Registers"), parent);
...
RegisterGroup *createFPUWords(RegisterViewModelBase::Model *model, QWidget *parent) {
	...
	if (!catIndex.isValid())
		return nullptr;
	const auto group = new RegisterGroup(QObject::tr("FPU Status&&Control Registers"), parent);
...
RegisterGroup *createFPULastOp(RegisterViewModelBase::Model *model, QWidget *parent) {
	...
	const auto group = new RegisterGroup(QObject::tr("FPU Last Operation Registers"), parent);
...
RegisterGroup *createDebugGroup(RegisterViewModelBase::Model *model, QWidget *parent) {
	...
	const auto group = new RegisterGroup(QObject::tr("Debug Registers"), parent);
