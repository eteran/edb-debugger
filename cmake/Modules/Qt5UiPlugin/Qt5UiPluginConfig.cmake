...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5UiPlugin" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5UiPlugin_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::UiPlugin)
    ...
    macro(_populate_UiPlugin_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5UiPlugin_install_prefix}/lib64/qt5/plugins/${PLUGIN_LOCATION}")
