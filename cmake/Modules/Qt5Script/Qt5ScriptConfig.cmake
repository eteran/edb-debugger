...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5Script" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Script_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
macro(_populate_Script_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Script_install_prefix}/lib64/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Script)
    ...
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.5.1"
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.5.1/QtScript"
    )
    ...
    macro(_populate_Script_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Script_install_prefix}/lib64/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Script_check_file_exists(${imported_location})
