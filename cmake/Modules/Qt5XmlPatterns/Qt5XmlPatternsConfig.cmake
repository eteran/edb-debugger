...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5XmlPatterns" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5XmlPatterns_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
macro(_populate_XmlPatterns_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5XmlPatterns_install_prefix}/lib64/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.5.1"
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.5.1/QtXmlPatterns"
    )
    ...
    macro(_populate_XmlPatterns_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5XmlPatterns_install_prefix}/lib64/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_XmlPatterns_check_file_exists(${imported_location})
