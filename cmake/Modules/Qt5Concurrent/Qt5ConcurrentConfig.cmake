...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5Concurrent" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Concurrent_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
macro(_populate_Concurrent_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Concurrent_install_prefix}/lib64/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Concurrent)
    ...
    macro(_populate_Concurrent_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Concurrent_install_prefix}/lib64/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Concurrent_check_file_exists(${imported_location})
