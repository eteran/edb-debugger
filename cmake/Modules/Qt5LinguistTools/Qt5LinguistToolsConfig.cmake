...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5LinguistTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5_linguisttools_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::lrelease)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/lib64/qt5/bin/lrelease")
...
if (NOT TARGET Qt5::lupdate)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/lib64/qt5/bin/lupdate")
    _qt5_LinguistTools_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::lconvert)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/lib64/qt5/bin/lconvert")
    _qt5_LinguistTools_check_file_exists(${imported_location})
